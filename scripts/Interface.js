export class Interface {
    ...
    detectColitionLeft({ rec1, rec2 }) {
        return (rec1.attackBox.position.x - rec1.attackBox.width < rec2.position.x + rec2.width &&
            rec1.attackBox.position.x > rec2.position.x &&
    ...
    detectColitionRight({ rec1, rec2 }) {
        return (rec1.attackBox.position.x + rec1.attackBox.offset.x + rec1.attackBox.width > rec2.position.x &&
            rec1.attackBox.position.x + rec1.attackBox.offset.x < rec2.position.x + rec2.width &&
            rec1.attackBox.position.y < rec2.position.y + rec2.height &&
            rec1.attackBox.position.y + rec1.attackBox.height > rec2.position.y)
